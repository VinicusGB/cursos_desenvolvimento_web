...
SECRET_KEY = '3ifs^kj^x676t_rit2-l2_sm9gde6rl(ksto=h+h0cerffly3c'
...
LANGUAGE_CODE = 'pt-br' #LANGUAGE_CODE = 'en-us' #Padrão Django

TIME_ZONE = 'America/Sao_Paulo' #TIME_ZONE = 'UTC' #Padrão Django
